...
Temos aprendido como criar e usar estruturas de dados na {\bf Memoria principal}. O CPU e memória são onde nosso software trabalha e executa. Estes são o
